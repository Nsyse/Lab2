...
2015-02-01 Ajout de l'option "D�connexion";
*******************************************************/  
...
public class MenuFenetre extends JMenuBar{
	...
	private static final String
			...
			MENU_FICHIER_DECONNECTER = "app.frame.menus.file.deconnexion";
	...
	protected void addMenuFichier() {
		JMenu menu = creerMenu(MENU_FICHIER_TITRE, new String[] { MENU_FICHIER_DECONNECTER, MENU_FICHIER_QUITTER });
		menu.getItem(0).addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				comm.stopCommunicationServeur();
				rafraichirMenus();
				comm.creerCommunicationServeur();
			}
		});
		menu.getItem(0).setAccelerator(
				KeyStroke.getKeyStroke(MENU_FICHIER_CONNECTER_TOUCHE_RACC,
